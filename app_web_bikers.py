...
.block-container { padding-top: 0rem !important; padding-bottom: 180px !important; }
...
try:
    ...
    st.write("Caricamento in corso o file non trovato...")
...
<div style='position: fixed; bottom: 0; left: 0; width: 100%; background: #1f2124; padding: 20px 0; border-top: 3px solid #ff9100; display: flex; justify-content: space-around; z-index: 9999;'>
    <b style='color:#ff9100; font-family: Special Elite;'>HOME</b><b style='color:#ff9100; font-family: Special Elite;'>MC</b><b style='color:#ff9100; font-family: Special Elite;'>ADMIN</b>
</div>
""", unsafe_allow_html=True)
